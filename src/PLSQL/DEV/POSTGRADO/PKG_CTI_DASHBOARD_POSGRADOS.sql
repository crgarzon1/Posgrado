...
-- POSTGRADO.
-- GRANT EXECUTE ON PKG_NOTAS TO ADMISIONES;
-- DESARROLLOSPRE.
GRANT SELECT ON CTI_CAMPANIA TO POSTGRADO;
...
DROP TYPE TABLE_DATA_SET;
/
DROP TYPE REGISTRO_DATA_ITEM;
/
DROP PACKAGE PKG_CTI_DASHBOARD_POSGRADOS;
/
...
CREATE OR REPLACE TYPE REGISTRO_DATA_ITEM AS OBJECT (
	VALOR NUMBER
);
/
...
CREATE OR REPLACE TYPE TABLE_DATA_SET AS
	TABLE OF REGISTRO_DATA_ITEM;
/
...
-- 
-- ****************************************************************************************************************************
CREATE OR REPLACE PACKAGE PKG_CTI_DASHBOARD_POSGRADOS AS
    ...
    */    
    ...
    /*
    OBTIENE LOS SIGUIENTES INDICADORES DE LAS INSCRIPCIONES DE UN PROGRAMA ACADï¿½MICO:
        - HABEAS DATA.
        - FORMULARIO 1.
        - FORMULARIO 2.
        - PAGO DE INSCRIPCIï¿½N.
        - ENTREVISTADOS.
        - ADMITIDOS.
        - MATRICULADOS.
    @param P_CODIGO_FACULTAD VARCHAR2  => CODIGO FACULTAD.
    ...
    */
    ...
    /*
    OBTENER NUMERO DE ESTUDIANTES POR TIPO DE INGRESO, FILTRADOS POR PROGRAMA ACADï¿½MICO.
    @param P_CODIGO_FACULTAD VARCHAR2  => CODIGO FACULTAD.
    @param P_JORNADA_FACULTAD VARCHAR2 => JORNADA FACULTAD.
    */
    ...
    */
    ...
    @return                          => Objeto JSON con valores.
    */
