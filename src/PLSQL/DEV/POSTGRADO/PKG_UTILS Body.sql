        ...
        CURSOR C_LISTADO_PERFILES (
            ...
            FROM   (SELECT    P.ID_PERFIL,
                    ...
                    LEFT JOIN (SELECT      FU.NOMBRE, 
                               ...
                               INNER JOIN  POSTGRADO.A_FACULTADES_UNICA FU ON P1.CODIGO = FU.CODIGO_FACULTAD
                               GROUP BY    FU.NOMBRE,
                                           FU.CODIGO_FACULTAD
                               UNION
                               SELECT      FU.NOMBRE, 
...
-- ****************************************************************************************************************************
    ...
    BEGIN
        ...
        FOR MENUITEM IN (SELECT ID_PROCESO
            ...
            JSON_LIST.APPEND (V_RESPUESTA, GETMENUITEM(MENUITEM.ID_PROCESO).TO_JSON_VALUE);
        END LOOP;
...
-- ****************************************************************************************************************************
    ...
    FUNCTION GETMENUITEM (
        ...
        V_ID_TIPO_EJECUCION VARCHAR2 (256);
    ...
    BEGIN
        ...
        FOR MENUITEM IN (SELECT ID_PROCESO
            ...
            JSON_LIST.APPEND (V_NODOS_HIJOS, GETMENUITEM(MENUITEM.ID_PROCESO).TO_JSON_VALUE);
        END LOOP;
